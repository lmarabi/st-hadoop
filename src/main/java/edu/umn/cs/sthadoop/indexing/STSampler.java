...
public class STSampler {
	
	  private static final Log LOG = LogFactory.getLog(STSampler.class);
	  ...
	  private static <T extends TextSerializable> int sampleMapReduceWithRatio(
	    ...
	    JobConf job = new JobConf(params, STSampler.class);
	    ...
	    STSampler.sizeOfLastProcessedFile = inputBytesCounter.getValue();
