 ...
 * This class support both csv with pickup_time only, or with both pickup and dropoff times. 
 *  #csv = id, pickupdate_time , [dropoff_time]+ , [longitude & latitude, longitude & latitude]*
...
public class STNycTrajectory extends STRectangle{
	...
	public void fromText(Text text) {
		...
		int incremmental = (startTime.equals(endTime)) ? 2 : 3; 
		double tempx, tempy;
