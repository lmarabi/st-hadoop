/***********************************************************************
* Copyright (c) 2017 by Regents of the University of Minnesota.
 ...
 * First operation supports trajectory dataset.
 * Example: Find the K nearest animal to a food source P x,y during time interval [t 1 ,t 2 ].
 * @author Louai Alarabi
 *
 */
public class HSPKNNQ {
  /**Logger for KNN*/
  private static final Log LOG = LogFactory.getLog(HSPKNNQ.class);
  ...
  private static<S extends Shape> long knnLocal(Path inFile, Path outPath,
    ...
    if (gIndex != null) {
      ...
      PriorityQueue<ShapeWithDistance<Partition>> partitionsToProcess =
          new PriorityQueue<HSPKNNQ.ShapeWithDistance<Partition>>() {
        {
  ...
  private static void printUsage() {
    System.out.println("Performs a HSPKNN query on an input file");
