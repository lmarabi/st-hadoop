...
public class HdfsInputFormat<S extends STPoint> extends FileInputFormat<Partition, HdfsDataPartitions<S>> {
	...
	// reference points
	@Override
	public RecordReader<Partition, HdfsDataPartitions<S>> createRecordReader(InputSplit split,
