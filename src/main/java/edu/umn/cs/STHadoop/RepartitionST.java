...
/**
 * This class create a spatial index for each temporal slice layers. 
 * 
 * @author Louai Alarabi
 */
public class RepartitionST extends Repartition {

	static final Log LOG = LogFactory.getLog(RepartitionST.class);

	public RepartitionST() {
		super();
	}
	...
	public static void repartitionMapReduce(Path[] inputPaths, Path outputPath,
		...
		JobConf job = new JobConf(params, RepartitionST.class);
	...
	public static void main(String[] args) throws IOException, ParseException, InterruptedException {
		...
		if (params.get("sindex") == null) {
			System.err
					.println("Please specify type of index to build (grid, rtree, r+tree, str, str+,quadtree)");
			printUsage();
			return;
		}
