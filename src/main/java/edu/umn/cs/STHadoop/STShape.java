...
public interface STShape extends Writable, Cloneable, TextSerializable {
   ...
   */
  public double distanceD(double x, double y);
  
  /**
   * Gets the distance of this shape time to the given time.
   * @param t The time as string ISO fromat
   * @return The Euclidean distance between this object and the given point
   */
  public double distanceT(String t);
