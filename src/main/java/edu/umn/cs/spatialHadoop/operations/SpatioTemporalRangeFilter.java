 ...
 *
 */
public class SpatioTemporalRangeFilter extends DefaultBlockFilter {
  ...
  private StShape queryRange;
  
  public SpatioTemporalRangeFilter() {}
  
  public SpatioTemporalRangeFilter(StShape shape) {
  ...
  public void configure(Configuration job) {
    ...
    if (this.queryRange == null)
      this.queryRange = OperationsParams.getStShape(job, QueryRange);
  }
  ...
  public void selectCells(GlobalIndex<Partition> gIndex,
    ...
    if (gIndex.isReplicated()) {
      ...
      Interval queryMBR = this.queryRange.getMBR();
