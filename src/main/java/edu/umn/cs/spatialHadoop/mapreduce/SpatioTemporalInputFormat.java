...
import edu.umn.cs.spatialHadoop.operations.SpatioTemporalRangeFilter;
 ...
 *
 */
public class SpatioTemporalInputFormat<K extends Interval, V extends StShape>
    extends FileInputFormat<K, Iterable<V>> {
  
  private static final Log LOG = LogFactory.getLog(SpatioTemporalInputFormat.class);
  ...
  public RecordReader<K, Iterable<V>> createRecordReader(InputSplit split,
      ...
      if (extension.equals("rtree")) {
        ...
        return (RecordReader)new SpatioTemporalRTreeRecordReader<V>();
      }
      ...
      Class<?> recordReaderClass = conf.getClass("SpatialInputFormat."
          + extension + ".recordreader", SpatioTemporalRecordReader.class);
      try {
  ...
  protected List<FileStatus> listStatus(JobContext job) throws IOException {
    try {
      ...
      if (jobConf.get(InputQueryRange) != null) {
        ...
        blockFilter = new SpatioTemporalRangeFilter(OperationsParams.getStShape(jobConf, InputQueryRange));
      }
