...
import edu.umn.cs.spatialHadoop.core.SpatioTemporalCellInfo;
import edu.umn.cs.spatialHadoop.io.TextSerializerHelper;

public class SpatioTemporalPartition extends SpatioTemporalCellInfo {
  ...
  public SpatioTemporalPartition(String filename, SpatioTemporalCellInfo cell) {
    this.filename = filename;
    super.set(cell);
  }
  
  public SpatioTemporalPartition(SpatioTemporalPartition other) {
    this.filename = other.filename;
    this.recordCount = other.recordCount;
    this.size = other.size;
    super.set((SpatioTemporalCellInfo)other);
  }
  ...
  @Override
  public SpatioTemporalPartition clone() {
    return new SpatioTemporalPartition(this);
  }
  ...
  public boolean equals(Object obj) {
    if (obj == null)
      return false;
    return this.filename.equals(((SpatioTemporalPartition)obj).filename);
  }
  
  public void expand(SpatioTemporalPartition p) {
    super.expand(p);
    // accumulate size
    this.size += p.size;
