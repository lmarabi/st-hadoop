...
var tabs=function(){
    ...
    d.prototype={
        ...
        h:function(){
            for(var a=0,b=this.d.length;a<b;a++)if(c(this.d[a],"selected"))return a;return 0
            },
        j:function(d,c){
            for(var b=d.getAttribute("rel"),a=0;a<this.b.length;a++)if(this.b[a].getAttribute("rel")==b){
                ...
                }else h(this.b[a].parentNode,"selected");this.l(b)
            },
        k:function(b,c){
            if(document.cookie.indexOf("tabContent=")==-1)document.cookie="tabContent="+a+b+"="+c+";path=/";
    ...
    m:function(a){
        if(a.id)for(var b=0;b<this.b.length;b++)if(this.b[b].getAttribute("rel")==a.id)return this.b[b];return a.parentNode.nodeName!="BODY"?this.m(a.parentNode):null
        },
    n:function(d,c){
